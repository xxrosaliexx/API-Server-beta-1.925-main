...
export default class Repository {
    constructor(ModelClass, cached = true) {   //on passe une instance d'un model
    ...
    getAll(params = null, dontBind = false) {  
        ...
        let collectionFilter = new CollectionFilter(bindedDatas, params, this.model);  //filtre de collection
        if (collectionFilter.valid()) //méthode retourne vrai si paramètres (ligne 151) sont corrects
