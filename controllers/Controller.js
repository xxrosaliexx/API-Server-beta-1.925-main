    ...
    get(id) {
        if (this.repository != null) {
            if (id !== undefined) {
                ...
                let data = this.repository.getAll(this.HttpContext.path.params);  //les params = params extrait de queryString (getAll est dans repository)
                if (this.repository.valid())  //on veut tous les enregistrements si pas de id
